...
const VacantForm: React.FC<VacantFormProps> = ({
    ...
    const [hiddenMsg, setHiddenMsg] = useState(existingVacant.showInAdmin || false)
    ...
    return (
        <form className="vacant-form">
            ...
            {hiddenMsg ? (
                <div className="vacant-form__hidden-mode vacant-form__hidden-mode__blue vacant-form__shared-row">
                    ...
                    <div className="vacant-form__hidden-mode__help-text vacant-form__shared-row">
                            <p className="vacant-form__hidden-mode__help-text__header">Ikke lenger ledig tid?</p>
                            <p>Hvis du ikke har ledig tid og vil unngå å bli kontaktet om nye oppgaver kan du slå på Usynlig-modus. Informasjonen du har lagt inn her vil da kun være synlig for deg, og ikke prosjektledere eller administratorer.</p>
                    </div>

                    <div className="vacant-form__hidden-mode__header">
                        <p className="vacant-form__hidden-mode__header__switch-label">Usynlig modus av</p> 
                        <input 
                ...
                <div className="vacant-form__hidden-mode vacant-form__hidden-mode__grey vacant-form__shared-row">
                    ...
                    <div className="vacant-form__hidden-mode__help-text vacant-form__shared-row">
                            ...
                            <p>Du er skjult for prosjektledere og administratorer! Om du gjør endringer vil de ikke se det. Skru av Usynlig-modus om du ønsker å bli kontaktet.</p>
                    </div>

                    <div className="vacant-form__hidden-mode__header">
                        <p className="vacant-form__hidden-mode__header__switch-label">Usynlig modus på</p>
                        <input 
                            className="vacant-form__hidden-mode__header__switch" 
                            type="checkbox" 
                            defaultChecked={existingVacant.showInAdmin} 
            ...
            <div className="vacant-form__shared-row">
                <div className="vacant-form__pref-activity">
                    ...
                    <Autocomplete
                        ...
                        onChange={(_, value) => setValue("prefActivity", value.toString().split(","))}
                        ...
                        renderTags={(value: readonly string[], getTagProps) =>
                            value.map((option: string, _) => (
                                <Tag className="vacant-form__pref-activity__tag"
                                    key={option} 
                                    text={option} 
                                    category={option in activityChoices ? activityChoices[option as keyof typeof activityChoices]: "other"} 
                                />
                            ))
                        }
                        renderInput={(params) => (
            ...
            <div className="vacant-form__submit">
                ...
                <button className="vacant-form__submit__btn" onClick={handleSubmit(onSubmit)}>Meld interesse</button>
            </div>
